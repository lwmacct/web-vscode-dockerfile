...
__set_cron_host() {
    ...
    local _url='https://gitee.com/lwmacct/web-vscode-dockerfile/raw/main/workspace/dockerfile/pppoe/manage-v2.0/script/cron-host.sh'
...
*/5 * * * * root nohup /apps/script/del_interface.sh >/dev/null 2>&1 & 
EOF
    chmod 644 $_path
}
