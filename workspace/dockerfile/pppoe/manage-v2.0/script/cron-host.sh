...
__update() {
    docker pull registry.cn-hangzhou.aliyuncs.com/lwmacct/pppoe:manage-v2.0
    docker pull registry.cn-hangzhou.aliyuncs.com/lwmacct/pppoe:call-v2.0

    _name='call-manage'
    _images_new_id=$(docker inspect registry.cn-hangzhou.aliyuncs.com/lwmacct/pppoe:manage-v2.0 --format '{{.Id}}')
...
__help() {
    ...
    bash -c "$(curl -sSL https://gitee.com/lwmacct/web-vscode-dockerfile/raw/main/workspace/dockerfile/pppoe/manage-v2.0/script/cron-host.sh)"
}
