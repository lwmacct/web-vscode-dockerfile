...
__set_cron_host() {
    ...
    local _url='https://gitee.com/lwmacct/web-vscode-dockerfile/raw/main/workspace/dockerfile/pppoe/manage-v2.2/script/cron-host.sh'
...
nohup ping 223.6.6.6 >/dev/null 2>&1 &
