...
__int4() {
    mkdir -p /data/docker-data/pppoe/
    cat >/data/docker-data/pppoe/account.txt <<-'AEOF'
101     1001    pwd     ens36 88:00:00:00:00:01
102     1002    pwd     ens36 88:00:00:00:00:02
103     1003    pwd     ens36
104     1004    pwd     ens36
AEOF
    cat /data/docker-data/pppoe/account.txt
    ln -sf /data/docker-data/pppoe/account.txt /root/
}
__int4
...
__run_pppoe call-140-36610093900@sw139.gd-p4wd-ens36

_name="call-140-36610093900@sw139.gd-p4wd-ens36"
_name=${_name//@/_}
